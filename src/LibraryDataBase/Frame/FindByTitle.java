...
public class FindByTitle extends JFrame{
    ...
    public FindByTitle(){
        ...
        titleField.setBounds(130, 50, 100, 30);
        ...
        button1.addActionListener(e -> {
            ...
            for (Book book : inFileDataBase.findByTitle(titleField.getText())) {
